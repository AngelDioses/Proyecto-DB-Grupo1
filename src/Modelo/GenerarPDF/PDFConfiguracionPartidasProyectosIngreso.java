...
public class PDFConfiguracionPartidasProyectosIngreso {
    public void generarPDF(JTable tablaProy_Partida_Mezcla_I, String empresa, String ruc) {
        try {
            ...
            latexContent.append("\\textbf{\\Large Reporte de Configuración de Partidas de Proyecto (Ingreso)}\n");
