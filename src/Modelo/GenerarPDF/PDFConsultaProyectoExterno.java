 ...
 * @author angel
 */
public class PDFConsultaProyectoExterno {
    public void generarPDF(JTable tablaProyecto, String empresa, String ruc) {
        try {
            ...
            latexContent.append("\\textbf{\\Large Reporte de Proyectos Externo}\n");
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reporteProyectosExterno.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reporteProyectos.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Consulta Proyecto Externo\\reporteProyectosExterno.pdf"), StandardCopyOption.REPLACE_EXISTING);
