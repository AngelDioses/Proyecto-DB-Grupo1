...
public class PDFConfiguracionPartidasIngreso {
    public void generarPDF(JTable tablaPartidaMezcla_I, String empresa, String ruc) {
        try {
            ...
            latexContent.append("\\textbf{\\Large Reporte de Configuración de Partidas de Ingreso}\n");
