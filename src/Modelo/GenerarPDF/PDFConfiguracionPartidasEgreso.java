...
public class PDFConfiguracionPartidasEgreso {
    public void generarPDF(JTable tablaPartidaMezcla_E, String empresa, String ruc) {
        try {
            ...
            latexContent.append("\\textbf{\\Large Reporte de Configuración de Partidas de Egreso}\n");
