...
public class PProy_Partida_MezclaDAO implements CRUD <PProy_Partida_Mezcla>{
    ...
    @Override
    public List listar() {
       List<PProy_Partida_Mezcla> lista = new ArrayList<>();
        ...
        try{
            ...
            while(rs.next()){
                PProy_Partida_Mezcla ppm = new PProy_Partida_Mezcla();
    ...
    public int add(PProy_Partida_Mezcla p) {
    ...
    public int actualizar(PProy_Partida_Mezcla p) {
    ...
    public void eliminar(int id) {
       String sql1="DELETE from PPROY_PARTIDA_MEZCLA where CORR="+id;
        try{
            ...
            ps.close();
            con.close();
            JOptionPane.showMessageDialog(null, "PProy_Partida_Mezcla eliminado con exito.");
        } catch (Exception e){
            JOptionPane.showMessageDialog(null, "Excepcion.\n"+e.toString());
            System.out.println(e.toString());
        }
    ...
    public PProy_Partida_Mezcla listarId(int cia,String tipo, int id,int corr,int ver,int pyto){
        PProy_Partida_Mezcla pm = new PProy_Partida_Mezcla();
    ...
    public PProy_Partida_Mezcla listarId2(int cia,String tipo, int id,int pyto){
        PProy_Partida_Mezcla pm = new PProy_Partida_Mezcla();
    ...
    public List eliminarCodPartida(List<PProy_Partida_Mezcla> lista,int id,String tip,int pyto){
