...
public class V_Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Aquí puede acceder al Presupuesto Externo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        V_Principal_Externo vPrincipalExterno = new V_Principal_Externo(this); // 'this' pasa la referencia de V_Principal
        vPrincipalExterno.setVisible(true);
        this.dispose(); // Cierra la ventana actual (V_Principal)
