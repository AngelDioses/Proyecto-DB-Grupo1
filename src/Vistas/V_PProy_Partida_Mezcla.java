...
public class V_PProy_Partida_Mezcla extends javax.swing.JPanel {

    public V_PProy_Partida_Mezcla() {
        initComponents();
        setOpaque(false);
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pdf.generarPDF(tablaProy_Partida_Mezcla_E, nombreEmpresa, ruc);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pdf.generarPDF(tablaProy_Partida_Mezcla_I, nombreEmpresa, ruc);
        JOptionPane.showMessageDialog(this, "PDF generado exitosamente", "Información", JOptionPane.INFORMATION_MESSAGE);
