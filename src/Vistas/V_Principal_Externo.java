...
import Controlador.C_PDProy_Partida_Mezcla;
import Controlador.C_Login;
import Controlador.C_PPartida;
import Controlador.C_PProyecto;
import Controlador.C_PPartida_Mezcla;
import Controlador.C_PProy_Partida;
import Controlador.C_PProy_Partida_Mezcla;
...
public class V_Principal_Externo extends javax.swing.JFrame {
    ...
    public void init(){
            ...
            public void menuSelected(int index,int subindex) {
                if (index == 0) { //INICIO
                    ...
                    if(subindex==0){
                        ...
                        C_PProy_Partida_Mezcla cppc=new C_PProy_Partida_Mezcla(vppm);
                    }
                }else if (index == 4) {//PRESUPUESTO
                    if(subindex==0){
                        V_PDProy_Partida_Mezcla vdppm =new V_PDProy_Partida_Mezcla();
                        mainBody.displayForm(vdppm,"Partidas");
                        C_PDProy_Partida_Mezcla cdppm=new C_PDProy_Partida_Mezcla(vdppm);
                    }
        ...
        menu.addEventShowPopup(new EventShowPopupMenu() {
            ...
            public void showPopup(Component com){
                ...
                PopupMenu popup = new PopupMenu(V_Principal_Externo.this, item.getIndex(), item.getEventSelected(), item.getMenu().getSubMenu());
                int x = V_Principal_Externo.this.getX() + 52;
                int y = V_Principal_Externo.this.getY() + com.getY() + 86;
