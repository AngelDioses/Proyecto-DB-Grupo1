...
public class V_PDProy_Partida_Mezcla extends javax.swing.JPanel {

    public V_PDProy_Partida_Mezcla() {
        initComponents();
        setOpaque(false);
        init();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pdf.generarPDF(tablaDProy_Partida_I, nombreEmpresa, ruc);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pdf.generarPDF(tablaDProy_Partida_E, nombreEmpresa, ruc);
        JOptionPane.showMessageDialog(this, "PDF generado exitosamente", "Información", JOptionPane.INFORMATION_MESSAGE);
