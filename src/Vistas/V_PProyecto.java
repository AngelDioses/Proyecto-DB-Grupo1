...
import Modelo.GenerarPDF.PDFConsultaProyectoExterno;
import static Vistas.V_Login.varCodCiaGlobalDeLogin;
import javax.swing.JOptionPane;


public class V_PProyecto extends javax.swing.JPanel {
    public int opt=-1;
    public V_PProyecto() {
        initComponents();
        setOpaque(false);
    ...
    private void initComponents() {
        ...
        nomPyto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nomPytoActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PDFConsultaProyectoExterno pdf = new PDFConsultaProyectoExterno();
        pdf.generarPDF(tablaProyecto, nombreEmpresa, ruc);
        JOptionPane.showMessageDialog(this, "PDF generado exitosamente", "Información", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void nomPytoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nomPytoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nomPytoActionPerformed
