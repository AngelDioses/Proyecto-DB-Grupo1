...
public class V_PProy_Partida extends javax.swing.JPanel {

    public V_PProy_Partida() {
        initComponents();
        setOpaque(false);
        init();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pdf.generarPDF(tablaProy_Partida_E, nombreEmpresa, ruc);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pdf.generarPDF(tablaProy_Partida_I, nombreEmpresa, ruc);
        JOptionPane.showMessageDialog(this, "PDF generado exitosamente", "Información", JOptionPane.INFORMATION_MESSAGE);
