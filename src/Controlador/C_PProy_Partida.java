...
import Modelo.DAO.PProy_PartidaDAO;
...
public class C_PProy_Partida implements ActionListener, KeyListener, MouseListener{
    
    PProy_PartidaDAO ppDAO = new PProy_PartidaDAO();
    V_PProy_Partida vpp = new V_PProy_Partida();
    ...
    public C_PProy_Partida(V_PProy_Partida vpp){
        this.vpp=vpp;
    ...
    public void initListarProyectos_I(){
        ...
        List<PProyecto> lista = new PProyectoDAO().listarPorCodCia(varCodCiaGlobalDeLogin);
    ...
    public void initTablaProy_Partida_I(){
        List<PProy_Partida> listaI = new PProy_PartidaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"I");
    ...
    public void initTablaProy_Partida_E(){
        List<PProy_Partida> listaE = new PProy_PartidaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"E");
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(e.getSource()==vpp.tablaProy_Partida_I){
            ...
            PProy_Partida pI = new PProy_PartidaDAO().listarId(varCodCiaGlobalDeLogin,pyto,ver,cod,"I");
        ...
        if(e.getSource()==vpp.tablaProy_Partida_E){
            ...
            System.out.println("PartidaMezcla = "+cod);
            PProy_Partida pE = new PProy_PartidaDAO().listarId(varCodCiaGlobalDeLogin,pyto,ver,cod,"E");
