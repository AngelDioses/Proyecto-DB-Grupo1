...
import Vistas.V_PDProy_Partida_Mezcla;
import Modelo.DAO.PDProyPartidaMezclaDAO;
import Modelo.DAO.PProy_Partida_MezclaDAO;
import Modelo.DAO.PProyectoDAO;
import Modelo.PDProyPartidaMezcla;
import Modelo.Message.Mensaje1;
import Modelo.Message.Mensaje2;
import Modelo.PProy_Partida_Mezcla;
...
public class C_PDProy_Partida_Mezcla implements ActionListener,MouseListener,ItemListener{
    
    V_PDProy_Partida_Mezcla vpm=new V_PDProy_Partida_Mezcla();
    PDProyPartidaMezclaDAO dpmDAO = new PDProyPartidaMezclaDAO();
    ...
    public C_PDProy_Partida_Mezcla(V_PDProy_Partida_Mezcla vpm){
        this.vpm=vpm;
    ...
    public void initListarProyectos_I(){
        ...
        List<PProyecto> listaPI = new PProyectoDAO().listarPorCodCia(varCodCiaGlobalDeLogin);
    ...
    public void initListarProyectos_E(){
        ...
        List<PProyecto> listaPE = new PProyectoDAO().listarPorCodCia(varCodCiaGlobalDeLogin);
    ...
    public void initListarPartidas(int codpyto){
        ...
        List<PProy_Partida_Mezcla> listaParI = new PProy_Partida_MezclaDAO().listarCodPartida(varCodCiaGlobalDeLogin,"I",codpyto);
        List<PProy_Partida_Mezcla> listaParE = new PProy_Partida_MezclaDAO().listarCodPartida(varCodCiaGlobalDeLogin,"E",codpyto);
        new PProy_Partida_MezclaDAO().eliminarCodPartida(listaParI,varCodCiaGlobalDeLogin,"I",codpyto);
        new PProy_Partida_MezclaDAO().eliminarCodPartida(listaParE,varCodCiaGlobalDeLogin,"E",codpyto);
    ...
    public void initTablaPartidaMezcla_I(){
        List<PDProyPartidaMezcla> listaI = new PDProyPartidaMezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"I");
    ...
    public void initTablaPartidaMezcla_E(){
        List<PDProyPartidaMezcla> listaE = new PDProyPartidaMezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"E");
    ...
    public void mouseClicked(MouseEvent e) {
         ...
         if(e.getSource()==vpm.tablaDProy_Partida_I){
            ...
            PDProyPartidaMezcla pmI = new PDProyPartidaMezclaDAO().listarId(semilla,"I");
        ...
        if(e.getSource()==vpm.tablaDProy_Partida_E){
            ...
            PDProyPartidaMezcla pmE = new PDProyPartidaMezclaDAO().listarId(semilla,"E");
    ...
    public void registrarDatos(String tip){
        PDProyPartidaMezcla pm = new PDProyPartidaMezcla();
        Date fecha = null;
        if(tip == "I"){
            ...
            PProy_Partida_Mezcla pmI = new PProy_Partida_MezclaDAO().listarId2(varCodCiaGlobalDeLogin,"I",pm.getCodPartida(),pm.getCodPyto());
            ...
            PProy_Partida_Mezcla pmE = new PProy_Partida_MezclaDAO().listarId2(varCodCiaGlobalDeLogin,"E",pm.getCodPartida(),pm.getCodPyto());
