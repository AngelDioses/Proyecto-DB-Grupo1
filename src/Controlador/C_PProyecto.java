...
public class C_PProyecto implements ActionListener, KeyListener, MouseListener{

    V_PProyecto vPro=new V_PProyecto();
    DefaultTableModel modelProyecto = new DefaultTableModel();
    TableRowSorter<DefaultTableModel> sorter;
    int fila=-1;
    int optionBusqueda=-1;
    
    public C_PProyecto(V_PProyecto vPro){
        this.vPro=vPro;
    ...
    public void registrarDatos(){
        ...
        PProyecto proyecto = new PProyecto.Builder()
...
//        }
        ...
        if(new PProyectoDAO().add(proyecto)==1){
...
//            }
//            //////////////////////////////////////////////////////////////////////////
            if(new PProyectoDAO().actualizar(proyecto)==1){
    ...
    public void eliminarDatos(){
        ...
        if(fila!=-1){//Si hay filas seleccionadas (cuando no se selecciona ninguna se retorna -1, por ello la comparacion), entonces:
            System.out.println("Hay filas seleccionadas.");
            int codProyecto = Integer.parseInt(vPro.tablaProyecto.getValueAt(fila,0).toString());
            new PProyectoDAO().eliminar(codProyecto);
        }else{
            showMessage1("Error al actualizar Proyecto");
        }
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource()==vPro.tablaProyecto){
            ...
            PProyecto pyto = new PProyectoDAO().listarId(codProyecto);
    ...
    public void traerLogoBDD(PProyecto pyto){
