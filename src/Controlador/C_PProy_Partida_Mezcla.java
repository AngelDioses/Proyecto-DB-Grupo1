...
import Vistas.V_PProy_Partida_Mezcla;
...
public class C_PProy_Partida_Mezcla implements ItemListener,ActionListener, KeyListener, MouseListener{
    
    PProy_Partida_MezclaDAO ppmDAO = new PProy_Partida_MezclaDAO();
    V_PProy_Partida_Mezcla vppm = new V_PProy_Partida_Mezcla();
    ...
    public C_PProy_Partida_Mezcla(V_PProy_Partida_Mezcla vppm){
        this.vppm=vppm;
    ...
    public void initListarPartidas(int pyto){
        ...
        List<PPartida_Mezcla> listaParIP = new PPartida_MezclaDAO().listarMezclas(varCodCiaGlobalDeLogin,"I");
        List<PPartida_Mezcla> listaParAuxIP = new PPartida_MezclaDAO().listarMezclasPadre(varCodCiaGlobalDeLogin,"I");
        List<PPartida_Mezcla> listaParEP = new PPartida_MezclaDAO().listarMezclas(varCodCiaGlobalDeLogin,"E");
        List<PPartida_Mezcla> listaParAuxEP = new PPartida_MezclaDAO().listarMezclasPadre(varCodCiaGlobalDeLogin,"E");
    ...
    public void initTablaProyPartidaMezcla_I(){
        List<PProy_Partida_Mezcla> listaI = new PProy_Partida_MezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"I");
    ...
    public void initTablaProyPartidaMezcla_E(){
        List<PProy_Partida_Mezcla> listaE = new PProy_Partida_MezclaDAO().listarPorCodCia(varCodCiaGlobalDeLogin,"E");
    ...
    public void mouseClicked(MouseEvent e) {
       ...
       if(e.getSource()==vppm.tablaProy_Partida_Mezcla_I){
            ...
            PProy_Partida_Mezcla pmI = new PProy_Partida_MezclaDAO().listarId(varCodCiaGlobalDeLogin,"I",cod,cor,ver,pyto);
       ...
       if(e.getSource()==vppm.tablaProy_Partida_Mezcla_E){
            ...
            PProy_Partida_Mezcla pmE = new PProy_Partida_MezclaDAO().listarId(varCodCiaGlobalDeLogin,"E",cod,cor,ver,pyto);
    ...
    public void registrarDatos(String tip){
        PProy_Partida_Mezcla pm = new PProy_Partida_Mezcla();
        if(tip == "I"){
    ...
    public void actualizarDatos(String tip){
        ...
        if(tip == "I"){
            ...
            if(fila!=-1){
                ...
                new PProy_Partida_MezclaDAO().actualizar(pm);
