...
drop table PPROY_PARTIDA_MEZCLA cascade constraints; 
...
CREATE TABLE PPROYECTO ( 
                ...
                Observac VARCHAR2(500) NOT NULL, 
                Vigente VARCHAR2(1) NOT NULL, 
                CONSTRAINT PPROYECTO_PK PRIMARY KEY (CodCIA, CodPyto) 
); 
...
CREATE TABLE PPARTIDA( 
                ...
                Semilla NUMBER(5) NOT NULL, 
                Vigente VARCHAR2(1) NOT NULL, 
                CONSTRAINT PPARTIDA_PK PRIMARY KEY (CodCia,IngEgr,CodPartida) 
); 
...
CREATE TABLE PPARTIDA_MEZCLA( 
                ...
                Orden NUMBER(5) NOT NULL, 
                Vigente VARCHAR2(1) NOT NULL, 
                CONSTRAINT PPARTIDA_MEZCLA_PK PRIMARY KEY (CodCia,IngEgr,CodPartida,Corr) 
); 
...
CREATE TABLE PPROY_PARTIDA_MEZCLA( 
                CodCia NUMBER(6) NOT NULL, 
                CodPyto NUMBER(6) NOT NULL, 
                IngEgr VARCHAR2(1) NOT NULL, 
                NroVersion NUMBER(1) NOT NULL, 
                ...
                Cant NUMBER(7,3) NOT NULL, 
                CostoTot NUMBER(10,2) NOT NULL, 
                CONSTRAINT PPROY_PARTIDA_MEZCLA_PK PRIMARY KEY (CodCia,CodPyto,NroVersion, 
                IngEgr,CodPartida,Corr) 
); 
...
CREATE TABLE PPROY_PARTIDA( 
                ...
                CodEstado VARCHAR2(3) NOT NULL, 
                Vigente VARCHAR2(1) NOT NULL, 
                CONSTRAINT PPROY_PARTIDA_PK PRIMARY KEY (CodCia,CodPyto,NroVersion,IngEgr,CodPartida) 
...
CREATE TABLE PDPROY_PARTIDA_MEZCLA ( 
                CodCia NUMBER(6) NOT NULL, 
                CodPyto NUMBER(6) NOT NULL, 
                IngEgr VARCHAR2(1) NOT NULL, 
                NroVersion NUMBER(1) NOT NULL, 
                ...
                ImpDesembTot NUMBER(9,2) NOT NULL, 
                Semilla NUMBER(5) NOT NULL, 
                CONSTRAINT PDPROY_PARTIDA_MEZCLA_PK PRIMARY KEY (CodCia,CodPyto,IngEgr,NroVersion,CodPartida,Corr,Sec) 
); 
...
ALTER TABLE PPROYECTO ADD CONSTRAINT CIA_PPROYECTO_FK 
FOREIGN KEY (CodCIA) 
REFERENCES CIA (CodCIA); 

ALTER TABLE PPROYECTO ADD CONSTRAINT EMPLEADO_PPROYECTO_FK 
FOREIGN KEY (CodCIA, EmplJefeProy) 
REFERENCES EMPLEADO (CodCIA, CodEmpleado); 

ALTER TABLE PPROYECTO ADD CONSTRAINT CLIENTE_PPROYECTO_FK 
FOREIGN KEY (CodCIA, CodCliente) 
REFERENCES CLIENTE (CodCIA, CodCliente); 

ALTER TABLE PPROYECTO ADD CONSTRAINT EMPRESA_VTA_PPROYECTO_FK 
FOREIGN KEY (CodCIA, CiaContrata) 
REFERENCES EMPRESA_VTA (CodCIA, CiaContrata); 
...
ALTER TABLE PPARTIDA ADD CONSTRAINT CIA_PPARTIDAFK 
FOREIGN KEY (CodCia) 
REFERENCES CIA (CodCia); 
...
ALTER TABLE PPROY_PARTIDA ADD CONSTRAINT PROYECTO_PPROY_PARTIDA_FK 
FOREIGN KEY (CodCia,CodPyto) 
REFERENCES PPROYECTO(CodCia,CODPYTO); 

ALTER TABLE PPROY_PARTIDA ADD CONSTRAINT PARTIDA_PPROY_PARTIDA_FK 
FOREIGN KEY (CodCia,IngEgr,CodPartida) 
REFERENCES PPARTIDA (CodCia,IngEgr,CodPartida); 
...
ALTER TABLE PPARTIDA_MEZCLA ADD CONSTRAINT PARTIDA_PPARTIDA_MEZCLA_FK 
FOREIGN KEY (CodCia,IngEgr,CodPartida) 
REFERENCES PPARTIDA (CodCia,IngEgr,CodPartida); 

ALTER TABLE PPARTIDA_MEZCLA ADD CONSTRAINT ELEMENTOS_PPARTIDA_MEZCLA_FK 
FOREIGN KEY (TUniMed,EUniMed) 
REFERENCES ELEMENTOS (CodTab,CodElem); 
...
ALTER TABLE PPROY_PARTIDA_MEZCLA ADD CONSTRAINT PROY_PARTIDA_PPROY_PARTIDA_MEZCLA_FK 
FOREIGN KEY (CodCia,CodPyto,NroVersion,IngEgr,CodPartida) 
REFERENCES PPROY_PARTIDA (CodCia,CodPyto,NroVersion,IngEgr,CodPartida); 

ALTER TABLE PPROY_PARTIDA_MEZCLA ADD CONSTRAINT ELEMENTOS_PPROY_PARTIDA_MEZCLA_FK 
FOREIGN KEY (TUniMed,EUniMed) 
REFERENCES ELEMENTOS (CodTab,CodElem); 
...
/*==============================================================*/ 
/* PDPROY_PARTIDA_MEZCLA                                          */ 
/*==============================================================*/ 

ALTER TABLE PDPROY_PARTIDA_MEZCLA ADD CONSTRAINT PROY_PARTIDA_MEZCLA_PDPROY_PARTIDA_MEZCLA_FK 
FOREIGN KEY (CodCia, CodPyto, IngEgr, NroVersion, CodPartida, Corr) 
REFERENCES PPROY_PARTIDA_MEZCLA (CodCia, CodPyto, IngEgr, NroVersion, CodPartida, Corr); 

ALTER TABLE PDPROY_PARTIDA_MEZCLA ADD CONSTRAINT ELEMENTOS_PDPROY_PARTIDA_MEZCLA_Desembolso_FK 
FOREIGN KEY (TDesembolso, EDesembolso) 
REFERENCES ELEMENTOS (CodTab,CodElem); 

ALTER TABLE PDPROY_PARTIDA_MEZCLA ADD CONSTRAINT ELEMENTOS_PDPROY_PARTIDA_MEZCLA_Comprobante_FK 
FOREIGN KEY (TCompPago, ECompPago) 
REFERENCES ELEMENTOS (CodTab,CodElem); 
...
create sequence SEC_PPARTIDA_E 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1;
...
create sequence SEC_PPARTIDA_I 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PPARTIDA_MEZCLA_E 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PPARTIDA_MEZCLA_I 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PPROY_PARTIDA_MEZCLA_E 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PPROY_PARTIDA_MEZCLA_I 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PDPROY_PARTIDA_MEZCLA_E 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PDPROY_PARTIDA_MEZCLA_I 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PDPROY_PARTIDA_MEZCLA_PAGO 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PDPROY_PARTIDA_MEZCLA_ADELANTO 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1;  
...
create sequence SEC_PDPROY_PARTIDA_MEZCLA_SEMILLA_I 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1; 
...
create sequence SEC_PDPROY_PARTIDA_MEZCLA_SEMILLA_E 
  start with 1 
  increment by 1 
  maxvalue 99999 
  minvalue 1;    
...
BEGIN 
    ...
    -- Verificación para evitar duplicados en FLUJOCAJA
    BEGIN
        SELECT 1 
        INTO V_dummy 
        FROM FLUJOCAJA 
        WHERE CODCIA = :new.CODCIA 
        AND CODPYTO = :new.CODPYTO 
        AND INGEGR = :new.INGEGR 
        AND CODPARTIDA = :new.CODPARTIDA;
    EXCEPTION
    ...
    LOOP 
        ...
        -- Verificación para evitar duplicados en FLUJOCAJA_DET
        BEGIN
            SELECT 1 
            INTO V_dummy 
            FROM FLUJOCAJA_DET 
            WHERE ANNO = annoAuxiliar 
            AND CODCIA = :new.CODCIA 
            AND CODPYTO = :new.CODPYTO 
            AND INGEGR = :new.INGEGR 
            AND CODPARTIDA = :new.CODPARTIDA 
            AND ORDEN = :new.ORDEN;
...
/*INSERTAR PPROYECTO*/ 
create or replace PROCEDURE INSERTAR_PPROYECTO( 
    COD_CIA IN PPROYECTO.CODCIA%TYPE, 
    NOMPY IN PPROYECTO.NOMBPYTO%TYPE, 
    JEFE IN PPROYECTO.EMPLJEFEPROY%TYPE, 
    CIACONT IN PPROYECTO.CIACONTRATA%TYPE, 
    CODCLI IN PPROYECTO.CODCLIENTE%TYPE, 
    FECRE IN PPROYECTO.FECREG%TYPE, 
    ESTPYT IN PPROYECTO.ESTPYTO%TYPE, 
    FECEST IN PPROYECTO.FECESTADO%TYPE, 
    VALREF IN PPROYECTO.VALREFER%TYPE, 
    COSTOTOTSIN IN PPROYECTO.COSTOTOTSINIGV%TYPE, 
    IGV IN PPROYECTO.IMPIGV%TYPE, 
    COSTOT IN PPROYECTO.COSTOTOTAL%TYPE, 
    OBS IN PPROYECTO.OBSERVAC%TYPE, 
    ANNOIN IN PPROYECTO.ANNOINI%TYPE, 
    ANNOFI IN PPROYECTO.ANNOFIN%TYPE, 
    LOGO IN PPROYECTO.LOGOPROY%TYPE, 
    VIGENT IN PPROYECTO.VIGENTE%TYPE) 
IS 
BEGIN 
 INSERT INTO PPROYECTO (CodCIA,CodPyto,NombPyto,EmplJefeProy,CodCia1,CiaContrata,CodCC,CodCliente,FlgEmpConsorcio,CodSNIP, 
                       FecReg,CodFase,CodNivel,CodFuncion,CodSituacion,NumInfor,NumInforEntrg,EstPyto,FecEstado,ValRefer,CostoDirecto,CostoGGen,CostoFinan,ImpUtilidad, 
                       CostoTotSinIGV,ImpIGV,CostoTotal,CostoPenalid,CodDpto,CodProv,CodDist,FecViab,RutaDoc,AnnoIni,AnnoFin,CodObjC,LogoProy,TabEstado,CodEstado,Observac,Vigente) 
                       VALUES 
                       (COD_CIA,SEC_PPROYECTO.NEXTVAL,NOMPY,JEFE,-999,CIACONT,-999,CODCLI,'-','-', 
                       FECRE,0,0,'-',0,0,0,ESTPYT,FECEST,VALREF,-999,-999,-999,-999, 
                       COSTOTOTSIN,IGV,COSTOT,-999,'-','-','-','01-01-2022','RUTA_DOC',ANNOIN,ANNOFI,0,LOGO,'-1','1',OBS,VIGENT); 
END; 
/ 
...
/*INSERTAR PPROY_PARTIDA*/ 
create or replace NONEDITIONABLE PROCEDURE INSERTAR_PPROY_PARTIDA( 
...
IS 
BEGIN 
INSERT INTO PPROY_PARTIDA VALUES(CODCIA,CODPYTO,NROVERSION,INGEGRE,CODP,CODPAR,'1',1,'1',TABE,CODE,VIG); 
END; 
/ 
...
/*INSERTAR PPROY_PARTIDA_MEZCLA*/ 
create or replace NONEDITIONABLE PROCEDURE INSERTAR_PPROY_PARTIDA_MEZCLA( 
...
/*INSERTAR PDPROY_PARTIDA_MEZCLA*/ 
create or replace PROCEDURE INSERTAR_PDPROY_PARTIDA_MEZCLA( 
...
INSERT INTO PPROYECTO VALUES(1,SEC_PPROYECTO.NEXTVAL,'Consorcio Desarrollo',4,-999,10,-999,1,'-','-','20-09-2019',0,0,'-',0,0,0,1,'20-09-2020',9874.25,-999,-999,-999,-999,18604.12,17,19604.12,-999,'-','-','-','01-01-2021','RUTA_DOC',2019,2026,0,NULL,-1,1,'Observacion de precio alta.','1'); 
INSERT INTO PPROYECTO VALUES(2,SEC_PPROYECTO.NEXTVAL,'Consorcio Sierra Sur',5,-999,11,-999,2,'-','-','21-09-2017',0,0,'-',0,0,0,2,'21-09-2018',7874.22,-999,-999,-999,-999,19604.12,18,20604.12,-999,'-','-','-','01-01-2021','RUTA_DOC',2017,2024,0,NULL,-1,1,'Observacion de precio alta.','1'); 
INSERT INTO PPROYECTO VALUES(3,SEC_PPROYECTO.NEXTVAL,'Consorcio Lima',6,-999,12,-999,3,'-','-','17-02-2021',0,0,'-',0,0,0,3,'17-02-2022',17674.23,-999,-999,-999,-999,22604.12,19,23604.12,-999,'-','-','-','01-01-2021','RUTA_DOC',2021,2028,0,NULL,-1,1,'Observacion de precio alta.','0'); 
...
/* PPARTIDAS */
INSERT INTO PPARTIDA VALUES(1,'I',SEC_PPARTIDA_I.NEXTVAL, 
 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Ingreso','1',1,'2','2',0,'1'); 
INSERT INTO PPARTIDA VALUES(1,'I',SEC_PPARTIDA_I.NEXTVAL, 
 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Venta','1',1,'2','2',0,'1'); 
INSERT INTO PPARTIDA VALUES(1,'E',SEC_PPARTIDA_E.NEXTVAL, 
 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Trafico','1',1,'1','1',0,'1'); 
INSERT INTO PPARTIDA VALUES(1,'E',SEC_PPARTIDA_E.NEXTVAL, 
 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Topografía','1',1,'1','1',0,'1'); 
INSERT INTO PPARTIDA VALUES(1,'E',SEC_PPARTIDA_E.NEXTVAL, 
...
/* PPARTIDA MEZCLA */
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'I',1,SEC_PPARTIDA_MEZCLA_I.NEXTVAL, 
 0,'2','2',1000000,1,1,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'I',2,SEC_PPARTIDA_MEZCLA_I.NEXTVAL, 
 1,'2','2',2000000,2,2,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',6,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 0,'1','1',1000,1,1,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',1,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 6,'1','1',2000,2,1,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',2,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 6,'1','1',3000,2,2,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',3,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 6,'1','1',4000,2,3,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',4,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 6,'1','1',5000,2,4,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',5,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 6,'1','1',6000,2,5,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',7,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 4,'1','1',7000,3,1,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',8,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 4,'1','1',8000,3,2,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',9,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 4,'1','1',9000,3,3,'1'); 
INSERT INTO PPARTIDA_MEZCLA VALUES(1,'E',10,SEC_PPARTIDA_MEZCLA_E.NEXTVAL, 
 4,'1','1',10000,3,4,'1'); 
...
/* PPROY_PARTIDA */
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'I',1,'10,000,00','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'I',2,'10,000,01','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',1,'10,000,02','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',2,'10,000,03','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',3,'10,000,04','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',4,'10,000,05','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',5,'10,000,06','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',6,'10,000,07','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',7,'10,000,08','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',8,'10,000,09','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',9,'10,000,10','1',1,'1','-1','1','1'); 
INSERT INTO PPROY_PARTIDA VALUES(1,1,1,'E',10,'10,000,11','1',1,'1','-1','1','1');  
...
/*PPROY_PARTIDA_MEZCLA*/
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'I',1,1,SEC_PPROY_PARTIDA_MEZCLA_I.nextval,0,'2','2',1,1,1000000,1,1000000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'I',1,2,SEC_PPROY_PARTIDA_MEZCLA_I.nextval,1,'2','2',2,1,2000000,1,2000000);
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,6,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,0,'1','1',1,1,1000,1,1000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,1,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,6,'1','1',2,1,2000,1,2000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,2,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,6,'1','1',2,2,3000,1,3000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,3,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,6,'1','1',2,3,4000,1,4000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,4,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,6,'1','1',2,4,5000,1,5000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,5,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,6,'1','1',2,5,6000,1,6000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,7,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,4,'1','1',3,1,7000,1,7000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,8,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,4,'1','1',3,2,8000,1,8000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,9,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,4,'1','1',3,3,9000,1,9000); 
INSERT INTO PPROY_PARTIDA_MEZCLA VALUES(1,1,'E',1,10,SEC_PPROY_PARTIDA_MEZCLA_E.nextval,4,'1','1',3,4,10000,1,10000); 
